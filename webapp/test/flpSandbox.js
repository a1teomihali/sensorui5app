		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#devuiappsensormanager-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"devuiappsensormanager-display": {
								"semanticObject": "devuiappsensormanager",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=devuiapp.sensormanager",
									"url": sap.ui.require.toUrl("devuiapp/sensormanager")
								}
							}
						}
					}
